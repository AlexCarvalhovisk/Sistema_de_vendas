...
type
  TdmConexao = class(TDataModule)
    ...
    sqlFdqPedidoDeVendas: TFDQuery;
    dspPedidoDeVendas: TDataSetProvider;
    cdsPedidoDeVendas: TClientDataSet;
    cdsProdutoCodigo: TIntegerField;
    cdsProdutoDescricao: TStringField;
    cdsProdutoPreco_de_vendas: TCurrencyField;
      ...
      for Contador := 0 to Pred(ListaParametros.Count) do
        begin
          ...
          begin
            ...
            //O Trim, acaba com os espaços entre palavras da String, seja antes ou depois.
...
//O sqlConexão é o banco de dados.
//O TQuery é o modulo que faz a consulta no banco de dados, por isso, ele deve ser linkado ao banco de dados.
//O Client Data Set ele é a tabela em memoria (cache), logo ele fica linkado na tabela ou (DbGrid).
//E por fim, o Provider é ele que persiste os dados no DB através das instruções SQL.
