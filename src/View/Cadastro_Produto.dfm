object frmCadastroProduto: TfrmCadastroProduto
  ...
  object pnlTop: TPanel
    ...
    TabOrder = 0
    ExplicitWidth = 1022
    object lblTextoFormularioProduto: TLabel
      Left = 367
      Top = 4
      Width = 267
      Height = 37
  ...
  object pnlAcoes: TPanel
    ...
    ExplicitLeft = 742
    ExplicitHeight = 415
    object lblDescricaoProduto: TLabeledEdit
      Left = 3
      Top = 296
      Width = 270
      Height = 29
    ...
    object lblPrecoVenda: TLabeledEdit
      Left = 3
      Top = 352
      Width = 270
      Height = 29
      EditLabel.Width = 121
      EditLabel.Height = 21
      EditLabel.Caption = 'Pre'#231'o do produto'
      TabOrder = 1
      Text = ''
    end
    ...
    object dbGridTabelaCliente: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Preco de Vendas'
          Visible = True
        end>
    end
  end
  object dsCadastroProdutos: TDataSource
    DataSet = dmConexao.cdsProduto
    Left = 208
    Top = 515
  end
end
