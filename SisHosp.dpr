...
uses
  ...
  Pedido_de_vendas in 'src\View\Pedido_de_vendas.pas' {frmPedidoDeVendas},
  Conexao in 'src\DAO\Conexao.pas' {dmConexao: TDataModule};
...
begin
  ...
  Application.CreateForm(TfrmPedidoDeVendas, frmPedidoDeVendas);
  Application.Run;
end.
